<?php
                ...
                <div class="col-md-2 product pt-md-5">
                    ...
                    <div class="cart-details">
                        ...
                        <div class="pro-price py-2">
                            <h5>
                                <small><s class="text-secondary">R{$row['productPrice']}</s></small>
                                <span>R{$row['productPriceDiscount']}</span>
                            </h5>
                        </div>
                        <div class="cart mt-4">
                ...
                <div class="row py-3">
                    ...
                    <div class="col-md-9 p-0 py-4 py-md-0">
                        <div class="px-4">
                            ...
                            <h5>
                                <small><s class="text-secondary">R{$row['productPrice']}</s></small>
                                <span class="text-color">R{$row['productPriceDiscount']}</span>
                            </h5>
                        </div>
                    </div>
                </div>
    ...
    function sendMessage(){
        if (isset($_POST['submit'])) {
            $to = "php.mailing.chiko@gmail.com";
            $_name = $_POST['name'];
            $_email = $_POST['email'];
