            ...
            <div class="row">
                <div class="col-md-6 col-12 pl-5">
                    ...
                    <p class="m-0 p-0 text-secondary">
                        Support Team 24/7 At +27 (71) 760-1825
                    </p>
                </div>
        ...
        <div class="container text-center">
            <p class="pt-5">
                <img src="./images/Footerpaypal.png" alt="payment image" class="img-fluid">
            </p>
            <small class="text-secondary py-4">Havenly Beds © 2020 Online Store. All Rights Reserved. Designed by Chiko Mutandwa</small>
        </div>
